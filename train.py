...
def train():
    if args.dataset == 'COCO':
        ...
        cfg = config.coco
        dataset = coco.COCODetection(root=args.dataset_root,
    ...
    for epoch in range(args.epochs):
        ...
        for iteration, (images, targets) in enumerate(data_loader):
            ...
            if iteration != 0 and iteration % 2000 == 0:
                ...
                torch.save(ssd_net.state_dict(), 'weights/ssd300_{}_{}.pth'.format(args.dataset, repr(iteration)))
